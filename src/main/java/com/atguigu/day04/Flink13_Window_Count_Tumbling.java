...
/**
 * ClassName: Flink13_Window_Count_Tumbling
 * Package: com.atguigu.day04
 * Description:
 *
 * @Author LeonWoo
 * @Create 2024/4/10 1:51
 * @Version 1.0
 */
public class Flink13_Window_Count_Tumbling {
    public static void main(String[] args) throws Exception {
        ...
        countWindow.process(new ProcessWindowFunction<String, String, String, GlobalWindow>() {
            @Override
            public void process(String s, ProcessWindowFunction<String, String, String, GlobalWindow>.Context context, Iterable<String> elements, Collector<String> out) throws Exception {
